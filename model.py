...
X['indices_depresion'] = X['indices_depresion'].apply(
    lambda x: utils.nivel_indices_to_int(x))
X['nivel_estres'] = X['nivel_estres'].apply(
    lambda x: utils.nivel_indices_to_int(x))
X['factores_socioeconomicos'] = X['factores_socioeconomicos'].apply(
    lambda x: utils.factores_to_int(x))
